    ...
    <div className="min-h-screen text-white bg-[#0B1026] relative overflow-hidden">
      ...
      <section id="portfolio" className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 pb-12 md:pb-20">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-base text-zinc-400 max-w-2xl mx-auto">
            Gerçek kullanıcılara hizmet veren projelerimiz. Tüm projeler canlıya alındığında linkler eklenecektir.
          </p>
        </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-zinc-100">Teknoloji Yığınımız</h2>
          <p className="mt-2 text-sm text-zinc-400">Projeleriniz için kullandığımız teknolojiler</p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Backend */}
          <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5 hover:bg-white/[0.04] transition-all">
            <div className="flex items-center gap-3 mb-4">
              <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#64748B]/20 to-[#475569]/20 border border-white/10 flex items-center justify-center">
                <svg className="w-4 h-4 text-[#64748B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
                </svg>
              </div>
              <h3 className="text-sm font-bold text-zinc-300">Backend</h3>
            </div>
            <div className="flex flex-wrap gap-2">
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">Node.js</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">NestJS</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">PostgreSQL</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">MongoDB</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">Redis</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5 hover:bg-white/[0.04] transition-all">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-sm font-bold text-zinc-300">Frontend</h3>
            </div>
            <div className="flex flex-wrap gap-2">
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">React</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">Next.js</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">React Native</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">TailwindCSS</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5 hover:bg-white/[0.04] transition-all">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-sm font-bold text-zinc-300">DevOps</h3>
            </div>
            <div className="flex flex-wrap gap-2">
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">Docker</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">AWS</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">Git</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5 hover:bg-white/[0.04] transition-all">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-sm font-bold text-zinc-300">API & Protokoller</h3>
            </div>
            <div className="flex flex-wrap gap-2">
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">REST API</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">GraphQL</span>
              <span className="text-xs px-2 py-1 rounded bg-white/5 text-zinc-300">WebSocket</span>
            </div>
          </div>
        </div>
      </section>
